...
EXCLUDES_FRESH = [addon_id, 'Addons33.db', 'kodi.log', 'script.module.certifi', 'script.module.chardet', 'script.module.idna', 'script.module.requests', 'script.module.urllib3', 'repository.709']
EXCLUDES_BASIC = excludes + [addon_id, 'Addons33.db', 'packages', 'backups', 'repository.709']
